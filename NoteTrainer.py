...
class SoundRecorder:
    ...
    def __init__(self):
        self.RATE=44100
        self.BUFFERSIZE=2048*4 #1024 is a good buffer size 3072 works for Pi
        self.secToRecord=.05
    ...
    def setup(self):
        ...
        self.inStream = self.p.open(format=pyaudio.paInt16,channels=1,rate=self.RATE,input=True,output=True,frames_per_buffer=self.BUFFERSIZE)
...
class NoteTrainer:
    ...
    def main(self):
        ...
        toggle = False
        stepchange = False
        soundgate = 80                            # zero is loudest possible input level
        targetnote=0
        ...
        while trys != 0:
            ...
            for n in range(0,screen_size[0],stepsize+1):
                ...
                #### raw_data_signal is the input signal data 
                ...
                self.CurrentNote.append([randint(1,2000),targetnote,tunerNotes[frequencies[targetnote]]])
        SR.close()        
